...
let productsCopy = document.querySelector(".products");
...
function showCategory(category) {
    ...
    let markup = '';
    items.forEach(product => markup += getProductMarkup(product));
    productsCopy.insertAdjacentHTML('afterbegin', markup);
}
